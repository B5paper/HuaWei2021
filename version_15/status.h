...
struct ServStat
{
    ...
    void node_map_mod(int old_serv_id, int old_node, int new_serv_id, int new_nod);
...
struct VirtualServ
{
    ...
    int get_res()
    {
        return nodes[0].cores_ream + nodes[0].mem_ream + nodes[1].cores_ream + nodes[1].mem_ream;
    }
};
