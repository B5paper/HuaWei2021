...
void dispatch_span(ServSpecList &serv_specs, VMSpecList &vm_specs, DayReqList &reqs, ServStatList &serv_stats, DayDispList &disps)
{
    for (int idx_day = 0; idx_day < reqs.size(); ++idx_day)
    {
        ...
        // while (!stop_mig)
        // {
        //     migrate(mig_scheme, serv_stats, serv_specs, vm_specs, num_miged, stop_mig);
        //     // cout << "num miged: " << num_miged << endl;
        // }
...
void dispatch(ServSpecList &serv_specs, VMSpecList &vm_specs, DayReqList &reqs, ServStatList &serv_stats, DayDispList &disps)
{
    for (int idx_day = 0; idx_day < reqs.size(); ++idx_day)
    {
        ...
        // dump_serv_stats(serv_stats, serv_specs, string("./serv_stats/day_") + to_string(idx_day) + string("_after_mig.txt"));
        ...
        // dump_serv_stats(serv_stats, serv_specs, string("./serv_stats/day_") + to_string(idx_day) + string("_after_add.txt"));
